...
| <a name="input_enable_cluster_creator_admin_permissions"></a> [enable\_cluster\_creator\_admin\_permissions](#input\_enable\_cluster\_creator\_admin\_permissions) | Whether to automatically grant admin permissions to the cluster creator's IAM role. | `bool` | `true` | no |
